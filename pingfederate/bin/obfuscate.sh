...
"$JAVA" -Dlog4j.configurationFile="file:///$DIRNAME_ESC/bin/obfuscate.log4j2.xml" -Drun.properties="$runprops" -Dpf.server.default.dir="$DEFAULT_DIR" -cp "$CLASSPATH" com.pingidentity.crypto.PasswordEncoder "$@"
